...
#
# BlockMatcher_Vivado_extraTimingEffort.tcl: Tcl script for re-creating project 'BlockMatcher_Vivado'
#
# Generated by Vivado on Tue Sep 24 00:19:24 CEST 2024
...
#
# 1. This project restoration tcl script (BlockMatcher_Vivado_extraTimingEffort.tcl) that was generated.
#
...
set _xil_proj_name_ "BlockMatcher_Vivado"
...
set script_file "BlockMatcher_Vivado_extraTimingEffort.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/BlockMatcher_Vivado"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: SeqMatcherHW_0, and set properties
  set SeqMatcherHW_0 [ create_bd_cell -type ip -vlnv EPFL_UMA:hls:SeqMatcherHW:1.0 SeqMatcherHW_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {106.967} \
    CONFIG.CLKOUT1_PHASE_ERROR {92.672} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {220} \
...
\
  ...
  connect_bd_intf_net -intf_net SeqMatcherHW_0_m_axi_port_q [get_bd_intf_pins SeqMatcherHW_0/m_axi_port_q] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net SeqMatcherHW_0_m_axi_port_t [get_bd_intf_pins SeqMatcherHW_0/m_axi_port_t] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins SeqMatcherHW_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net SeqMatcherHW_0_interrupt [get_bd_pins SeqMatcherHW_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net rst_ps8_0_214M_peripheral_aresetn [get_bd_pins SeqMatcherHW_0/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_214M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins SeqMatcherHW_0/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_214M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_q] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_q] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_t] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_t] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SeqMatcherHW_0/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_q] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SeqMatcherHW_0/Data_m_axi_port_t] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-319,-129",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 1030 -y 250 -defaultsOSRD
preplace inst SeqMatcherHW_0 -pg 1 -lvl 5 -x 1850 -y 540 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1510 -y 290 -defaultsOSRD
preplace inst rst_ps8_0_214M -pg 1 -lvl 1 -x 200 -y 270 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 560 -y 80 -defaultsOSRD
preplace inst axi_smc_1 -pg 1 -lvl 2 -x 560 -y 220 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -x 560 -y 370 -defaultsOSRD
preplace netloc SeqMatcherHW_0_interrupt 1 1 5 420 460 NJ 460 NJ 460 NJ 460 2030
preplace netloc rst_ps8_0_214M_peripheral_aresetn 1 1 4 390 310 700J 140 1360 560 NJ
preplace netloc xlconcat_0_dout 1 2 1 720J 300n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 5 20 170 380 300 710 430 1350 430 1660
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 4 20 430 NJ 430 700J 420 1340
preplace netloc SeqMatcherHW_0_m_axi_port_q 1 1 5 400 440 NJ 440 NJ 440 NJ 440 2050
preplace netloc SeqMatcherHW_0_m_axi_port_t 1 1 5 410 450 NJ 450 NJ 450 NJ 450 2040
preplace netloc axi_smc_1_M00_AXI 1 2 1 N 220
preplace netloc axi_smc_M00_AXI 1 2 1 720 80n
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 1 1670 290n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 N 230
levelinfo -pg 1 0 200 560 1030 1510 1850 2070
pagesize -pg 1 -db -bbox -sgen 0 0 2070 620
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/BlockMatcher_Vivado/BlockMatcher_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Synthesis 2022} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/BlockMatcher_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Implementation 2022} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "auto_rqs.directory" -value "$proj_dir/BlockMatcher_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/BlockMatcher_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
